...
> **🎯 文案语气约束（Vol.005+ 强制 · 同 Overview v2）**：
> - 平台是**情报雷达**(information broker)，不是策略指令交付。让读者自己拿判断，不替他做决定。
> - ❌ 硬指令禁用: `必须 / 立刻 / 严禁 / 硬规则 / 现成模板 / 碾压 / 最强判断 / 不能 / 务必 / 终极`
> - ❌ 绝对化禁用: `直接套用 / 直接抄 / 直接复用 / 永久流量公式 / 最高优先级 / 最优 / 最强 / 顶级`
> - ❌ 数字建议禁用: 不要给 `一周可出 50+ 草图` `一个英雄出 20+ 变体` 等具体产出量
> - ✅ 鼓励参考式: `较有代表性 / 较突出 / 可参考 / 不妨联想到 / 是个不错的起点 / 通用节奏 / 可衍生出`
